 ...
 * @author Fernando
 */
public class DialogoGato8 extends javax.swing.JDialog {

    
    public DialogoGato8(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(7).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(7).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(7).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(7).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(7).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(7).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Loki va por la vida como un eterno domingo al sol");

        jLabel2.setText("Vive sin preocupaciones, tumbandose boca arriba");

        jLabel3.setText("para descansar después de comer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato8 dialog = new DialogoGato8(new javax.swing.JFrame(), true);
