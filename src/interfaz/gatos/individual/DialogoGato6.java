 ...
 * @author Fernando
 */
public class DialogoGato6 extends javax.swing.JDialog {

    
    public DialogoGato6(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(5).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(5).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(5).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(5).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(5).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(5).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mardu es una gata preciosa y modelo");

        jLabel2.setText("De vez en cuando se gana un banquete haciendose fotos");

        jLabel3.setText("para productos de publicidad gatunos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato6 dialog = new DialogoGato6(new javax.swing.JFrame(), true);
