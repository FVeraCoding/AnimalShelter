 ...
 * @author Fernando
 */
public class DialogoGato2 extends javax.swing.JDialog {

    
    public DialogoGato2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(1).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(1).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(1).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(1).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(1).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(1).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mati es un gato programador.");

        jLabel2.setText("Ha colaborado en el desarrollo de esta aplicación");

        jLabel3.setText("dedicándose a dirigir los equipos y dar apoyo moral.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato2 dialog = new DialogoGato2(new javax.swing.JFrame(), true);
