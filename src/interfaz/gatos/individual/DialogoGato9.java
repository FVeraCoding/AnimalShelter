 ...
 * @author Fernando
 */
public class DialogoGato9 extends javax.swing.JDialog {

    
    public DialogoGato9(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(8).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(8).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(8).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(8).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(8).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(8).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Astrid es la gatita presumida de la manada");

        jLabel2.setText("También es preciosa por dentro");

        jLabel3.setText("siendo muy delicada con el resto de integrantes,");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato9 dialog = new DialogoGato9(new javax.swing.JFrame(), true);
