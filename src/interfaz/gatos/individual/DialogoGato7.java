 ...
 * @author Fernando
 */
public class DialogoGato7 extends javax.swing.JDialog {

    
    public DialogoGato7(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(6).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(6).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(6).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(6).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(6).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(6).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantra es la mirada pentrante");

        jLabel2.setText("El silencio, la contemplación");

        jLabel3.setText("Tiene cosas que enseñar a las personas espirituales.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato7 dialog = new DialogoGato7(new javax.swing.JFrame(), true);
