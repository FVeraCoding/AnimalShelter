 ...
 * @author Fernando
 */
public class DialogoGato5 extends javax.swing.JDialog {

    
    public DialogoGato5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(4).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(4).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(4).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(4).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(4).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(4).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Esper es un bebé de pocos meses");

        jLabel2.setText("Le gusta jugar con sus amigos y socializar");

        jLabel3.setText("Una familia con más gatitos es ideal para él.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato5 dialog = new DialogoGato5(new javax.swing.JFrame(), true);
