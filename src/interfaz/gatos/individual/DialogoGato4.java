 ...
 * @author Fernando
 */
public class DialogoGato4 extends javax.swing.JDialog {

    
    public DialogoGato4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(3).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(3).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(3).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(3).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(3).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(3).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Raspi será la niña de tus ojos.");

        jLabel2.setText("Es difícil decir que no vas a darle una chuche");

        jLabel3.setText("con esa mirada.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato4 dialog = new DialogoGato4(new javax.swing.JFrame(), true);
