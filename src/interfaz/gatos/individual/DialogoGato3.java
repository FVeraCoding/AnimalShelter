 ...
 * @author Fernando
 */
public class DialogoGato3 extends javax.swing.JDialog {

    
    public DialogoGato3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaGatos().get(2).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaGatos().get(2).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaGatos().get(2).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaGatos().get(2).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaGatos().get(2).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaGatos().get(2).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Beni es juguetón y risueño");

        jLabel2.setText("Ha aprendido a abrir las latas de atún");

        jLabel3.setText("De seguir así, pronto aprenderá python.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoGato3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoGato3 dialog = new DialogoGato3(new javax.swing.JFrame(), true);
