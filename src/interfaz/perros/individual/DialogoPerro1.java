 ...
 * @author Fernando
 */
public class DialogoPerro1 extends javax.swing.JDialog {

    
    public DialogoPerro1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(0).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(0).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(0).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(0).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(0).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(0).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Potito es un encantador chihuahua de tamaño pequeño");

        jLabel2.setText("Sus grandes ojos oscuros, llenos de ternura");

        jLabel3.setText("transmiten su deseo de encontrar un hogar lleno de amor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro1 dialog = new DialogoPerro1(new javax.swing.JFrame(), true);
