 ...
 * @author Fernando
 */
public class DialogoPerro5 extends javax.swing.JDialog {

    
    public DialogoPerro5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(4).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(4).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(4).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(4).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(4).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(4).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Max es noble y serio.");

        jLabel2.setText("Es el protector de los demás perros del grupo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro5 dialog = new DialogoPerro5(new javax.swing.JFrame(), true);
