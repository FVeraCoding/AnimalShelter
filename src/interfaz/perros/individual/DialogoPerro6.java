 ...
 * @author Fernando
 */
public class DialogoPerro6 extends javax.swing.JDialog {

    
    public DialogoPerro6(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(5).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(5).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(5).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(5).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(5).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(5).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lopolo es un perro encantador, aficionado al fútbol");

        jLabel2.setText("Siempre se sienta a tu lado cuando hay un partido del Sevilla");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro6 dialog = new DialogoPerro6(new javax.swing.JFrame(), true);
