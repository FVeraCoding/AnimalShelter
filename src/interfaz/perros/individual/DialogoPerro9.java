 ...
 * @author Fernando
 */
public class DialogoPerro9 extends javax.swing.JDialog {

    
    public DialogoPerro9(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(8).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(8).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(8).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(8).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(8).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(8).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lasie es un perro muy inteligente");

        jLabel2.setText("Solía ser pastor de ovejas hasta que su dueño cambió de profesión");

        jLabel3.setText("Ahora busca una familia con la que vivir feliz.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro9 dialog = new DialogoPerro9(new javax.swing.JFrame(), true);
