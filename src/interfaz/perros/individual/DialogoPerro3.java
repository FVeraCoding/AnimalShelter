 ...
 * @author Fernando
 */
public class DialogoPerro3 extends javax.swing.JDialog {

    
    public DialogoPerro3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(2).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(2).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(2).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(2).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(2).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(2).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sae es un Corgi travieso");

        jLabel2.setText("Ha aprendido a hacer el pino sobre dos patas");

        jLabel3.setText("Y es todo un atleta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro3 dialog = new DialogoPerro3(new javax.swing.JFrame(), true);
