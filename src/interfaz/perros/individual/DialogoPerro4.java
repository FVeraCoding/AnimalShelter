 ...
 * @author Fernando
 */
public class DialogoPerro4 extends javax.swing.JDialog {

    
    public DialogoPerro4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(3).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(3).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(3).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(3).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(3).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(3).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bob es uno de los perros más buenos del santurario");

        jLabel2.setText("Siempre te mira con unos ojos grandes y redondos");

        jLabel3.setText("Y una sonrisa de oreja a oreja");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro4 dialog = new DialogoPerro4(new javax.swing.JFrame(), true);
