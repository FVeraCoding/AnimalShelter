 ...
 * @author Fernando
 */
public class DialogoPerro2 extends javax.swing.JDialog {

    
    public DialogoPerro2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(1).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(1).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(1).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(1).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(1).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(1).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Shanna es un labrador fuerte y noble");

        jLabel2.setText("Aunque también se muestra cariñosa y juguetona");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro2 dialog = new DialogoPerro2(new javax.swing.JFrame(), true);
