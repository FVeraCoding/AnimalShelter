 ...
 * @author Fernando
 */
public class DialogoPerro7 extends javax.swing.JDialog {

    
    public DialogoPerro7(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jLabelNombre.setText(PerrosGatos.getListaPerros().get(6).getNombre());
        this.jLabelPeso.setText(jLabelPeso.getText() + " "+PerrosGatos.getListaPerros().get(6).getPeso());
        this.jLabelColor.setText(jLabelColor.getText() + " "+PerrosGatos.getListaPerros().get(6).getColor());
        this.jLabelRaza.setText(jLabelRaza.getText() + " "+PerrosGatos.getListaPerros().get(6).getRaza());
        this.jLabelSexo.setText(jLabelSexo.getText() + " "+PerrosGatos.getListaPerros().get(6).getSexo());
        this.setImageLabel(jLabelFoto, PerrosGatos.getListaPerros().get(6).getUrl());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("America es la libertad hecha perro");

        jLabel2.setText("Se mueve con ligereza, disfrutando la vida en cada aliento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoPerro7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoPerro7 dialog = new DialogoPerro7(new javax.swing.JFrame(), true);
